...
export default function Footer() {
    return (
        <footer>
            ...
            <p><b className="letter-green">BerkanaSports &copy; 2022 </b>- Diseño web por <a href="https://github.com/GeruMansi" target="_blank" rel="noreferrer">German</a>, <a href="https://jorge.osses.ar" target="_blank" rel="noreferrer">Jorge</a> y <a href="https://www.behance.net/barrerapaula" target="_blank" rel="noreferrer">Paula</a></p>
            </div>
        </footer>
    )
}